...
class Searchshopkeeper extends StatefulWidget {
  final String userEmail;
  const Searchshopkeeper({super.key, required this.userEmail});

  @override
  State<Searchshopkeeper> createState() => _SearchshopkeeperState();
}
...
class _SearchshopkeeperState extends State<Searchshopkeeper> {
